...
public class Qustion1Activity extends AppCompatActivity {
    TextView tvquesion;
    RadioButton tvop1;
    RadioButton tvop2;
    RadioButton tvop3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("QUESTION0", Context.MODE_PRIVATE);
        ...
        btnque1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("answer1",radioanswer.getText().toString());
                editor.commit();

                Intent intent = new Intent(Qustion1Activity.this,Question2Activity.class);
